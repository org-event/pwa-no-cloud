...
export const useNocloudStore = defineStore('nocloud', () => {
  ...
  return {
    ...
    onAddRelayUrl: servers.onAddRelayUrl,
    onSelectRelayUrl: servers.onSelectRelayUrl,
    onRemoveRelayUrl: servers.onRemoveRelayUrl,
    ...
    onIntroduceContact: contacts.onIntroduceContact,
    ...
    onAcceptCall: calls.onAcceptCall,
    onRejectCall: calls.onRejectCall,
    onHangUp: calls.onHangUp,
    onToggleMute: calls.onToggleMute,
    onToggleCamera: calls.onToggleCamera,
    onRenameAlias: contacts.onRenameAlias,
    onSetContactTrust: contacts.onSetContactTrust,
