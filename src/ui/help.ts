...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Поделиться',
        text: '«Получить ссылку»: Telegram, WhatsApp, «Копировать». Если сокет по HTTPS недоступен, ссылка будет приглашением (#j/), не короткой комнатой. Файл в ссылку не кладётся.',
      },
    ],
  },
  {
