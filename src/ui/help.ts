...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Файлы → ссылка для второго',
        text: 'Выбираете файлы, жмёте «Ссылка для второго», кидаете её в мессенджер. Второй открывает — канал сам сходится, он жмёт «Принять».',
      },
      {
        name: 'Без сокета',
        text: 'Если S1. без websocket, остаются два текста: приглашение и ответ.',
      },
    ],
  },
  {
    ...
    title: 'Контакты',
    href: '#contacts',
    lead: 'Как в мессенджере: постоянный id, сменные ник и картинка. Карточка уходит по каналу вместе с файлами — облачного аккаунта нет.',
    items: [
      {
        name: 'Id',
        text: 'Пишется на этом устройстве и не меняется. Ник и фото можно править; второй увидит новые, когда канал откроется.',
      },
      {
        name: 'Первая встреча',
        text: 'Незнакомый пришлёт ту же карточку. Спросим «В адресную книгу». Не сейчас — в этот раз больше не спросим.',
      },
      {
        name: 'Кому отправить',
        text: 'В «Передача» можно отметить человека или группу из книги. Группа — ярлык: ссылку всё равно откроет один человек, канал 1:1.',
      },
    ],
  },
  {
