...
export const HELP_TOPICS: HelpTopic[] = [
  {
    ...
    items: [
      ...
      {
        name: 'PWA',
        text: 'Установите на домашний экран — тогда ссылки и «поделиться» ведут в приложение, а не в случайную вкладку.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: 'Поделиться',
        text: 'На приглашении — «Поделиться ссылкой»: Telegram, WhatsApp, «Копировать». Вручную нужен ещё ответ вторым сообщением. С сокетом достаточно ссылки на комнату.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: 'Свой TURN / сокет',
        text: 'TURN нужен на сотовой и за жёстким NAT. Сокет (порт 8443) — чтобы не копировать N1.',
      },
    ],
  },
  {
    id: 'lan',
    title: 'Передача в локальной сети',
    href: '#lan',
    lead: 'Главный экран обмена. В одной Wi‑Fi часто хватает без TURN. Через интернет без своего релея канал может не открыться.',
    items: [
      {
        name: 'Создать приглашение / Войти в комнату',
        text: 'Вручную: первый создаёт N1, второй вставляет и отдаёт ответ. С сокетом: одно имя комнаты на обоих.',
      },
      {
        name: 'Поделиться ссылкой / комнатой',
        text: 'Открывает PWA у второго человека. Вручную после открытия ссылки всё равно нужен ответ.',
      },
      {
        name: 'Вложить мои серверы',
        text: 'В N1 уедет ваш TURN, если у второго своего нет. Сокет в приглашение не кладётся.',
      },
      {
        name: 'Отправить файл / папку',
        text: 'После канала, или в очередь до него. Получатель жмёт «Принять».',
      },
      {
        name: 'Входящие',
        text: 'Файлы на этом устройстве (OPFS). «Записать пример» — проверка хранилища, не сеть.',
      },
    ],
  },
  {
    ...
    title: 'Контакты',
    href: '#contacts',
    lead: 'Список людей ещё не собран. Сейчас каждый раз новое приглашение или комната.',
    items: [
      {
        name: 'Зачем будет',
        text: 'Сохранённые пиры и повторный звонок без копирования N1.',
      },
    ],
  },
  {
