...
export const contactsCopy = {
  ...
  cardCopied:
    'Карточка скопирована — вы в своей комнате и ждёте. Не закрывайте вкладку, пока второй вставит карточку.',
...
export const knockNeedS1Known = (nick: string) =>
  `${nick} в списке, но канал не откроется: вставьте пакет S1. в «Настройки сервера» на обоих. Одна Wi‑Fi без S1 не соединит.`;
